...
module.exports = function (server) {
    ...
    require('node-restful').mongoose.connect('mongodb://localhost:27017/ktpweb', {server:{auto_reconnect: true}}, function (err) {
        if (err) throw err;
        // web app
        ...
        require(__dirname+'/model/announcement').register(api,'/announcements')     // register our model to the api
